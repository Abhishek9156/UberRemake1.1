...
import com.example.uberremake.home.DriverHomeActivity;
        ...
        driverInfoRef.child(FirebaseAuth.getInstance().getCurrentUser().getUid())
                .addListenerForSingleValueEvent(new ValueEventListener() {
                    ...
                    public void onCancelled(@NonNull DatabaseError error) {
                        Toast.makeText(SplashScreenActivity.this, "Check user fire" + error.getMessage(), Toast.LENGTH_SHORT).show();
                    }
                });
    ...
    private void showRegisterLayout() {
        ...
        btn_continue.setOnClickListener(view1 -> {
            if (TextUtils.isEmpty(ed_first_name.getText().toString())) {
                ...
                model.setMobileNumber(ed_phone_number.getText().toString());
                model.setRating(0.0);
